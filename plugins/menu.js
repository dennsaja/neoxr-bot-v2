         ...
         if (style === 1) {
            ...
            if (text) {
               ...
               client.sendIAMessage(m.chat, buttons, m, {
                  header: `${Func.greeting()} @${m.sender.replace(/@.+/g, '')} 👋`,
                  content: print,
